...
class Property extends Model
{
    ...
    protected $fillable = [
        'name','owner','phonenumber','name_tr','featured_image','location_id','price','is_verified','promo_price','sale','type','bedrooms','drawing_rooms','bathrooms','net_sqm','gross_sqm','status','pool','overview','overview_tr','why_buy','why_buy_tr','description','description_tr','country_code','country_state'
    ];
