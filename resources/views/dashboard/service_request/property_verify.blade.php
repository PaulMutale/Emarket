    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('properties.request_verification', $property->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="owner" name="owner" value="{{ $property->owner }}" disabled>
                    </div>
