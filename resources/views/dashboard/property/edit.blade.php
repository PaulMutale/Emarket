    ...
    <div class="shadow p-3 mb-5 bg-white rounded">
        ...
        <form action="{{route('properties.update',$property->id)}}" method="post" enctype="multipart/form-data" class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                <label class="civanoglu-label" for="country name">Phone Number<span class="required-text" require>*</span></label>
                    <input type="number" name="phonenumber" class="civanoglu-input h-10" placeholder="Type here" value="{{ old('phonenumber') }}" require>
                </div>
            </div>
            <br>
