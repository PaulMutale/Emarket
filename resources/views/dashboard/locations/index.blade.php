<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('location.create') }}" class="py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Add New Location</a>
        </div>
    </x-slot>
                        ...
                        <tbody>
                            @forelse ($locations as $location)
                                <tr class="bg-green-300 hover:bg-red-500 hover:text-white duration-50">
                                    ...
                                    <td class="border py-2">{{ $location->name }}</td>
