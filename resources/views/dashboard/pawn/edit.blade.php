<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('pawn.index') }}" class="px-4 py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Back</a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-5 mx-auto w-100">
                    <form action="{{ route('pawn.update',$shop->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="flex items-end">
                            <div class="flex-auto">
                                <label for="name" class="civanoglu-label">Shop Name <span class="required-text">*</span></label>
