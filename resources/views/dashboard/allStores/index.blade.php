                        ...
                        <tbody>
                            @forelse ($stores as $shop)
                                <tr class="bg-green-300 hover:bg-red-500 hover:text-white duration-50">
                                    ...
                                    <td class="border py-2">{{ $shop->phonenumber }}</td>
                                    <td class="border py-2">{{ $shop->status }}</td>
                                    <td class="border py-2">
                                        <div class="flex items-center justify-center">
                                           <a href="{{ route('stores.verifyStore', $shop->id) }}" class="mx-1 hover:bg-black hover:text-white duration-200 leading-none bg-blue-700 text-white px-3 py-2 text-sm rounded-md">Verify</a>
