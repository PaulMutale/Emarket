<div class="emailBody">
    ...
    <hr>
    <center>
    <p>Thanks <br><small>If you did not make this request, no further action is required.<br>This is an automated email, do not reply.</small></p>

<hr>
© <?php echo date('Y');?> CLOUDTECH. All rights reserved.</center>
